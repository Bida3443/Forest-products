    ...
    return (
        <section className="relative">
            <div className="w-full lg:h-[70vh] h-[40vh] relative" >
                ...
                <div className="absolute inset-0 w-full h-full bg-black opacity-60 z-20" />
