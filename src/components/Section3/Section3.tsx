...
export default function OurProducts (){
    return( 
        <section className="bg-white pt-20  h-screen ">
            <div className="    overflow-hidden">
                <div className="flex justify-between mb-10 px-25">
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 px-25 md:px-6 lg:px-0">
