            ...
            <div className="flex justify-center items-center flex-col px-4">
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10 pt-10">
                  ...
                  viewport={{ once: true }}
                    ...
                    className="items-center bg-white justify-center w-full lg:max-w-130  p-4 rounded-xl border border-transparent hover:border-[#F0BD09] hover:shadow-md transition-all cursor-pointer duration-300 ">
