    ...
    <section className="bg-[#f3f3f3] min-h-screen   pt-20">
        <div className="flex justify-center items-center flex-col">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10 pt-10">
                <div className="items-center bg-white justify-center lg:w-130 w-100  p-4 rounded-xl border border-transparent hover:border-[#F0BD09] hover:shadow-md transition-all cursor-pointer duration-300 ">
